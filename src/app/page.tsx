...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    step3body: "No account, no download, no friction. Any smartphone camera opens your profile immediately — in the helper's language.",
    zfH1: 'Zero tracking.',
    zfH2: 'Zero installs.',
    zfH3: '100% yours.',
  ...
  es: {
    ...
    step3body: 'Sin cuenta, sin descarga, sin fricción. Cualquier cámara de smartphone abre tu perfil al instante — en el idioma del asistente.',
    zfH1: 'Cero rastreo.',
  ...
  fr: {
    ...
    step3body: "Pas de compte, pas de téléchargement, pas de friction. N'importe quelle caméra ouvre votre profil instantanément — dans la langue de l'assistant.",
    zfH1: 'Zéro traçage.',
  ...
  de: {
    ...
    step3body: 'Kein Konto, kein Download, keine Hürden. Jede Smartphone-Kamera öffnet dein Profil sofort — in der Sprache des Helfers.',
    zfH1: 'Null Tracking.',
  ...
  pt: {
    ...
    step3body: 'Sem conta, sem download, sem atrito. Qualquer câmera de smartphone abre seu perfil imediatamente — no idioma do assistente.',
