...
export default function QrPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 pb-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-xl font-bold text-[#1C2B1E]">My QR Code</h1>
        <p className="text-sm text-gray-500 mt-1">
          Scan this code or share the link to give helpers instant access to your emergency health profile
        </p>
      </div>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-sm bg-white rounded-2xl p-6 shadow-xl focus:outline-none">
              ...
              <Dialog.Description className="text-sm text-gray-500 mb-5">
                Your current QR code and URL will stop working immediately. Any printed cards,
                stickers, or shared links will no longer open your profile. This cannot be undone.
              </Dialog.Description>
      ...
      {qr && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-4">
          <p className="text-xs font-medium text-gray-500 mb-2">Your emergency profile URL</p>
          ...
          <p className="text-xs text-gray-400 mt-2">
            Anyone with this link can view your emergency health profile. It never changes unless you
            regenerate it.
          </p>
        </div>
      )}
      ...
      <div className="bg-[#E8F2E6] rounded-2xl p-4">
        <p className="text-sm font-semibold text-[#1C2B1E] mb-2">💡 Tips for sharing your QR code</p>
        <ul className="space-y-1 text-sm text-[#3a5e40]">
          <li>• Print it and add to your phone case</li>
          <li>• Attach to a medical bracelet or luggage tag</li>
          <li>• Share the link with family members</li>
          <li>• Place on your bike helmet or backpack</li>
        </ul>
      </div>
    </div>
  )
