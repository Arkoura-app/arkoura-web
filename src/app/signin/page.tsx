  ...
  async function handleRegister(data: z.infer<typeof registerSchema>) {
    ...
    try {
      ...
      try {
        ...
        // Non-blocking — account created successfully even if email fails
      }
      setRegistered(true)
  ...
  async function handleForgot(data: z.infer<typeof forgotSchema>) {
    ...
    try {
      ...
      if (response.status === 429) {
        setFirebaseError('Too many attempts. Please wait 10 minutes.')
        return
      }
      setResetSent(true)
    } catch {
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <Link href="/">
            ...
            <img src="/icon.png" alt="Arkoura" className="w-12 h-12 mx-auto mb-3" />
          </Link>
